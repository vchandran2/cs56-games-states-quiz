...
public class MapPanel extends JPanel implements ActionListener {
	...
	public MapPanel() {
		...
		try {
			map = ImageIO.read(getClass().getClassLoader().getResource(
					"image/map-of-united-states.jpg"));
	...
	/**
	 * @param g
	 *            Graphics object that prints the image of the map
	 */
	...
	/**
	 * @param button
	 *            button that was clicked by a user
	 */
	 ...
	 * 
	 * @param e
	 *            ActionEvent if user answered the question
	 */
